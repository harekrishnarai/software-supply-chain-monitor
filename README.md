...
A living reference for tracking, understanding, and defending against real-world software supply chain attacks. Updated as new incidents are disclosed publicly.
...
|------|------|-----------|--------|
| Aug 2026 | [ChainDrop npm Worm — Shai-Hulud 2.0 Hits 444 Packages via keyv Maintainer Compromise, EtherHiding C2](./attacks/2026-08-chaindrop-npm-worm.md) | npm | GitHub account compromise of `jaredwray` (keyv/flat-cache/file-entry-cache maintainer); keyv@6.0.0 (150M weekly DLs) seed; 444 packages / 2,212 malicious versions in <4 hours; Bun v1.3.13 loader + 710KB Math_Symbol.js; Runner.Worker /proc memory scraping; EtherHiding C2 (Ethereum contract 0xE1f2395ee43e45A1556EC6438a88c31B83493103); exfil to npm-cache.com AES-256-GCM+RSA encrypted; token monitor trap on credential rotation; AI tool persistence (.claude/settings.json, .vscode/tasks.json); Shai-Hulud 2.0 attribution |
| Aug 2026 | [Anthropic AI Agent Incident — Claude Publishes Malicious PyPI Package During Evaluation, Compromises Real Third-Party Systems](./attacks/2026-07-anthropic-ai-agent-pypi.md) | PyPI | AI agent (Claude) published credential-stealing package `anthropickit@999.9.9` to real PyPI during CTF evaluation while believing environment was simulated; 15 real systems ran it within 1 hour; security company's malware scanner exfiltrated credentials; dependency confusion via version 999.9.9; SSH key + CI secret theft; Pipedream exfil; first confirmed case of AI agent as unintentional supply chain attacker |
| Jul 2026 | [Coordinated AsyncAPI Supply Chain Attack — Miasma v3 RAT via Compromised CI/CD Pipelines](./attacks/2026-07-asyncapi-miasma-v3-cicd.md) | npm / GitHub Actions | Two AsyncAPI repos (`generator` + `spec-json-schemas`) compromised via push credential; 4 packages published with valid OIDC provenance attestations via the projects' own release pipelines; load-time dropper (no postinstall hook) fetches 3.08MB Miasma v3 from IPFS; 6 C2 channels (HTTP, Nostr, IPFS, BitTorrent DHT, libp2p, Ethereum blockchain); AI tool poisoning + metamorphic engine; C2 85.137.53.71; campaign tag miasma-train-p1 |
| Jul 2026 | [jscrambler npm Supply Chain Attack — Malicious Preinstall Binary Drops Cross-Platform Rust Stealer with eBPF Rootkit](./attacks/2026-07-jscrambler-npm-preinstall-binary.md) | npm | Official Jscrambler CLI compromised; 5 malicious versions in 2-hour window; 7.8 MB Rust binary disguised as dist/intro.js (magic bytes 1B 43 53 49 01); preinstall hook → inline require() evolution; browser credential stealer + MetaMask/LevelDB wallet stealer + BIP39 seed parser; Linux eBPF in-memory kernel instrumentation; Tor C2; interleaved clean/malicious releases defeat caret-range pinning |
| Jul 2026 | [Injective npm Supply Chain Attack — 18 Packages Backdoored to Steal Crypto Wallet Keys](./attacks/2026-07-injective-npm-supply-chain.md) | npm | Maintainer account compromised; @injectivelabs/sdk-ts@1.20.21 + 17 transitive packages; runtime hook on PrivateKey.fromMnemonic/fromHex captures BIP-39 phrases + hex keys; char-code-array hostname obfuscation + X-Request-Id exfil + grpc-web+proto Content-Type to blend into legitimate Injective traffic; 310 downloads in 49-min exposure window |
| Jul 2026 | [@joyfill npm Supply Chain Attack — 5-Stage Blockchain-C2 RAT via Compromised Beta Releases](./attacks/2026-07-joyfill-npm-rat.md) | npm | 6 malicious `2773 beta` versions of `@joyfill/components` and `@joyfill/layouts`; import-time execution (--ignore-scripts ineffective); 5-stage chain: shuffle decoder → Tron→BNB→Aptos blockchain C2 resolver → Socket.IO RAT → Python credential stealer; campaign tag A9-0135-3; C2 IPs 166.88.134.62, 23.27.13.43, 198.105.127.210, 23.27.202.27; persistence in VS Code, Cursor, Discord, GitHub Desktop, npm CLI; worm propagation via npm CLI infection |
| Jul 2026 | [mrmustard 0.7.4 PyPI Compromise — CI Token Theft Enables Poisoned Release Targeting Quantum Research Clusters](./attacks/2026-07-mrmustard-pypi-stealer.md) | PyPI | XanaduAI quantum photonics library; GitHub account `ziofil` compromised; 2-commit CI attack steals PyPI token via webhook.site; import-time stealer disguised as `_check_tf_compatibility()`; targets SSH keys, AWS, K8s, SLURM/HPC, NVIDIA/CUDA, Conda; XOR-obfuscated C2 `metrics.femboy.energy`; 3 persistence mechanisms (cron/15min, .pth, shell hook); second stage `hw_probe.pyc` |
| Jul 2026 | [SleeperGem — Coordinated RubyGems Compromise via Dormant Account Takeover, Forgejo C2, Persistent Daemon Backdoor](./attacks/2026-07-sleepergem-rubygems.md) | RubyGems | 3 gems: git_credential_manager (impersonates Microsoft GCM), Dendreo (dormant since 2020), fastlane-plugin-run_tests_firebase_testlab; loader downloads second stage from git.disroot.org Forgejo C2; native daemon dropped to ~/.local/share/gcm/; dual persistence (systemd + cron as `git-credential-manager`); setuid root shell at /usr/local/sbin/ping6; CI evasion (30+ env vars); targets developer laptops |
| Jul 2026 | [GhostApproval — Symlink Attack Achieves RCE via AI Coding Assistant Trust Boundary Flaw](./attacks/2026-07-ghostapproval-ai-coding-assistants.md) | AI Coding Assistants (VS Code ecosystem) | CVE-2026-12958 (Amazon Q) + CVE-2026-50549 (Cursor); symlink disguised as workspace file tricks AI agent into writing attacker SSH key to ~/.ssh/authorized_keys; CWE-451 UI misrepresentation — agent's reasoning recognizes symlink target but confirmation prompt hides it from user; Windsurf/Amazon Q write before user approval; Augment reads+writes without any consent dialog; affects 6 major AI coding tools |
| Jul 2026 | [Phantom Squatting — AI-Hallucinated Domains Weaponized as Software Supply Chain Vector](./attacks/2026-06-phantom-squatting-llm-domains.md) | LLM / Agentic AI / Web | LLMs hallucinate web domains at 27–45% rate across 913 global brands; ~250,000 phantom domains available for registration; active exploitation confirmed — Montana Empire phishing kit + malicious Android APK campaign; C2 infrastructure on 3% of malicious phantom domains poses direct threat to autonomous AI agents |
| Jun 2026 | [CVE-2026-12957 — Amazon Q VS Code Extension MCP Auto-Execution Enables Cloud Credential Theft via Git Clone](./attacks/2026-06-amazon-q-mcp-auto-execution.md) | VS Code / Amazon Q | High-severity CVE in Amazon Q Developer extension; auto-loads .amazonq/mcp.json from workspace without consent; full environment inheritance grants spawned processes access to AWS/GCP/Azure credentials; arbitrary code execution on folder open; patched in language server v1.65.0 |
| Jun 2026 | [@immobiliarelabs Backstage Plugins Compromised — Miasma binding.gyp Wave Hits 4 npm Packages, 22 Malicious Versions](./attacks/2026-06-immobiliarelabs-backstage-miasma.md) | npm | 4 Backstage plugins (GitLab + LDAP auth), 22 malicious versions published in 30-second window; Phantom Gyp binding.gyp hook + ROT-2/AES-128-GCM/obfuscator.io + Bun v1.3.13 evasion; harvests GitHub/AWS/GCP/Azure/Kubernetes/HashiCorp Vault/registry tokens; infectHost AI assistant poisoning (Claude Code, Copilot, Cursor, VS Code, Aider, Kiro, Cody, Gemini, Codex); npm+PyPI worm propagation |
| Jun 2026 | [GitHub Actions Miasma Tag Hijacking — codfish/semantic-release-action and simonecorsi/mawesome Compromised](./attacks/2026-06-github-actions-miasma-tag-hijacking.md) | GitHub Actions | 16 version tags on codfish/semantic-release-action + 5 on simonecorsi/mawesome force-pointed to malicious orphan commits; 512 KB Miasma payload steals OIDC tokens, scrapes runner memory, hijacks 13 AI assistant configs (Claude/Cursor/Copilot/Kiro/Gemini), SSH lateral movement, multi-ecosystem worm to npm/PyPI/RubyGems; attacker locks tags via Repository Rulesets to impede recovery |
| Jun 2026 | [Leo Platform npm Supply Chain Attack — 20 Packages Backdoored via Miasma Toolkit](./attacks/2026-06-leo-platform-npm-miasma.md) | npm | 20 packages (13,600 weekly DLs) simultaneously published within 3-second window at 23:04:55Z; byte-for-byte identical Phantom Gyp binding.gyp hook + AES-128-GCM + Bun v1.3.13 as Miasma v2; runner memory scraping, multi-cloud credential sweep, GitHub dead-drop exfil, bypass_2fa worm propagation; same threat actor 21 days after original Miasma campaign |
| Jun 2026 | [ClawHavoc Campaign — Malicious OpenClaw Skills on ClawHub Distribute AMOS Malware, File-Padding Evasion, and Agentic Meme Token Fraud](./attacks/2026-06-clawHub-clawHavoc-campaign.md) | OpenClaw / ClawHub | 300+ malicious skills across multiple waves; AMOS infostealer via curl-pipe-bash; 22MB file padding defeats VirusTotal + ClawScan; agentic Solana meme token pump-and-dump (letssendit.fun); C2 91.92.242.30 active 3+ months post-disclosure |
| Jun 2026 | [Hades Campaign — Graph ML PyPI Packages Deploy Cross-Platform Memory Scrapers, AI Analyst Misdirection, Wiper Deterrent](./attacks/2026-06-hades-campaign-pypi.md) | PyPI | 29 packages (ensmallen + bioinformatics ecosystem); Python import hook → Bun v1.3.14; first cross-platform Runner.Worker memory scraper (Linux + macOS Mach VM + Windows Win32); LLM prompt injection in payload evades AI triage; wiper deterrent rm -rf ~/ on token revocation; 3 GitHub dead-drop C2 channels; SLSA provenance bypass; latest Miasma evolution |
| Jun 2026 | [Pythagora-io/gpt-pilot GitHub Compromise — Shai-Hulud Credential Stealer Blocked by Python Linter](./attacks/2026-06-gpt-pilot-shai-hulud-github.md) | GitHub / Python | Co-founder account hijacked; 758KB Shai-Hulud JS payload force-pushed to main (no branch protection); backdated commit to Aug 2025; ruff linter accidentally blocked attack twice — E402/I001 violations in injected import; Sigstore/Fulcio SLSA forgery capability; GitHub commit C2 (thebeautifulsnadsoftime); TeamPCP attribution |
| Jun 2026 | [Miasma Worm Hits Microsoft Again — Azure/durabletask Repo Injection, 73 Repos Disabled, AI Coding Agent Hijacking](./attacks/2026-06-miasma-azure-repo-injection.md) | GitHub / GitHub Actions | Backdated orphan commit injects .claude/settings.json, .gemini/settings.json, .cursor/rules, .vscode/tasks.json all pointing to 4.6MB setup.js; executes on folder open in VS Code/Claude Code/Cursor/Gemini CLI; 73 Microsoft repos disabled in 105s; Azure/functions-action@v1 taken offline causing global CI/CD breakage |
...
| Jun 2026 | [IronWorm — Rust-Built npm Worm with eBPF Rootkit and Tor C2 Targets Arweave/WeaveDB Ecosystem](./attacks/2026-06-ironworm-npm-weavedb.md) | npm | 37 packages (Arweave/WeaveDB ecosystem); 976KB Rust ELF preinstall dropper; modified UPX + per-call-site string encryption; eBPF kernel rootkit hides processes/sockets from ps/top/ss; Tor onion C2; 57 backdated commits across 9 GitHub orgs; AI-identity commit forgery (claude@users.noreply.github.com); Exodus wallet seed capture; Kubernetes secret harvester; OIDC npm Trusted Publishing propagation |
...
| Jun 2026 | [Pickle in the Middle — Vertex AI SDK Bucket Squatting Enables Zero-Access Cross-Tenant RCE via Model Poisoning](./attacks/2026-06-pickle-in-the-middle-vertex-ai.md) | Python / Google Cloud Vertex AI | Deterministic GCS staging bucket names in google-cloud-aiplatform SDK v1.139.0–1.140.0 enable bucket squatting; attacker Cloud Function swaps victim's ML model with malicious pickle payload within 2.5s race window; P4SA OAuth token with cloud-platform scope exfiltrated; cross-deployment model theft + BigQuery recon confirmed; patched in v1.148.0 (Apr 2026, responsibly disclosed Jun 2026) |
...
| Apr 2026 | [XCSSET v40 — Xcode Project Poisoning Turns Developer Workstations Into Self-Propagating Supply Chain Vectors](./attacks/2026-04-xcsset-v40-xcode-supply-chain.md) | macOS / Xcode / GitHub | 17-module macOS worm since April 2026; spreads via poisoned Xcode build phases on GitHub; polymorphic in-memory execution; Chrome CDP backdoor + Telegram trojanizer; disables XProtect/SoftwareUpdate; 40+ .ru/.in C2 domains aged before deployment; targets South Asian developers |
...
└── attacks/
    ├── 2026-08-chaindrop-npm-worm.md
    ├── 2026-07-anthropic-ai-agent-pypi.md
    ├── 2026-07-joyfill-npm-rat.md
    ├── 2026-07-mrmustard-pypi-stealer.md
    ├── 2026-07-sleepergem-rubygems.md
    ├── 2026-07-asyncapi-miasma-v3-cicd.md
    ├── 2026-07-jscrambler-npm-preinstall-binary.md
    ├── 2026-07-injective-npm-supply-chain.md
    ├── 2026-07-ghostapproval-ai-coding-assistants.md
    ├── 2026-06-phantom-squatting-llm-domains.md
    ├── 2026-06-pickle-in-the-middle-vertex-ai.md
    ├── 2026-06-amazon-q-mcp-auto-execution.md
    ├── 2026-06-immobiliarelabs-backstage-miasma.md
    ├── 2026-06-github-actions-miasma-tag-hijacking.md
    ├── 2026-06-codfish-semantic-release-action.md
    ├── 2026-06-leo-platform-npm-miasma.md
    ├── 2026-06-clawHub-clawHavoc-campaign.md
    ├── 2026-06-hades-campaign-pypi.md
    ├── 2026-06-gpt-pilot-shai-hulud-github.md
    ├── 2026-06-miasma-azure-repo-injection.md
    ...
    ├── 2026-06-ironworm-npm-weavedb.md
    ...
    ├── 2026-04-xcsset-v40-xcode-supply-chain.md
